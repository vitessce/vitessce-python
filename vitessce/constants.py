...
class CoordinationType(DocEnum):
    ...
    SPATIAL_ROTATION = "spatialRotation", "The rotation of a spatial view."
...
class FileType(DocEnum):
    ...
    CLUSTERS_JSON = "clusters.json", "A JSON-based expression matrix file type (this file type is poorly named) - DEPRECATED"
    GENES_JSON = "genes.json", "A JSON-based expression matrix file type - DEPRECATED"
