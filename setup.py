...
class NPM(Command):
    ...
    targets = [
        os.path.join(here, 'vitessce', 'static', 'extension.js'),
        os.path.join(here, 'vitessce', 'static', 'index.js')
    ]
...
version_ns = {}
with open(os.path.join(here, 'vitessce', '_version.py')) as f:
