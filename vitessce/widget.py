...
class VitessceWidget(anywidget.AnyWidget):
    ...
    js_package_version = Unicode('3.3.0').tag(sync=True)
    js_dev_mode = Bool(False).tag(sync=True)
    custom_js_url = Unicode('').tag(sync=True)

    def __init__(self, config, height=600, theme='auto', uid=None, port=None, proxy=False, js_package_version='3.3.0', js_dev_mode=False, custom_js_url=''):
        """
...
def ipython_display(config, height=600, theme='auto', base_url=None, host_name=None, uid=None, port=None, proxy=False, js_package_version='3.3.0', js_dev_mode=False, custom_js_url=''):
