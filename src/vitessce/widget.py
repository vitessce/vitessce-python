...
class VitessceWidget(anywidget.AnyWidget):
    ...
    js_package_version = Unicode('4.0.5').tag(sync=True)
    ...
    def __init__(self, config, height=600, theme='auto', uid=None, port=None, proxy=False, js_package_version='4.0.5', js_dev_mode=False, custom_js_url='', plugins=None, remount_on_uid_change=True, prefer_local=True, invoke_timeout=300000, invoke_batched=True, page_mode=False, page_esm=None, prevent_scroll=True, server_host=None):
        """
...
def ipython_display(config, height=600, theme='auto', base_url=None, host_name=None, uid=None, port=None, proxy=False, js_package_version='4.0.5', js_dev_mode=False, custom_js_url='', plugins=None, remount_on_uid_change=True, page_mode=False, page_esm=None, server_host=None):
