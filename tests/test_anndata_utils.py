...
class TestAnnDataUtils(unittest.TestCase):
    ...
    def test_to_uint8_global_norm(self):
        ...
        np.testing.assert_almost_equal(norm_X.tolist(), [[254, 200, 250], [250, 50, 254], [105, 50, 100], [200, 70, 204]], decimal=0)

    def test_to_uint8_gene_norm(self):
        adata = self.adata
        norm_X = to_uint8(adata.X, norm_along="var")
        np.testing.assert_almost_equal(norm_X.tolist(), [[255, 255, 246], [246, 0, 255], [0, 0, 0], [161, 33, 172]], decimal=0)
