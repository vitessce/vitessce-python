...
class TestWrappers(unittest.TestCase):
    ...
    def test_snaptools(self):
        ...
        self.assertEqual(z['chromosomes/1/5000'].shape, (4, 56))
        self.assertEqual(z['chromosomes/1/5000'][:,0].sum(), 0)
        self.assertEqual(z['chromosomes/1/5000'][:,1].sum(), 0)
        self.assertEqual(z['chromosomes/1/5000'][:,2].sum(), 7)
        self.assertEqual(z['chromosomes/1/5000'][:,3].sum(), 7)
        self.assertEqual(z['chromosomes/1/5000'][:,4].sum(), 0)
        self.assertEqual(z['chromosomes/1/5000'][0,:].sum(), 17)
        self.assertEqual(z['chromosomes/1/10000'][0,:].sum(), 17)
        self.assertEqual(z['chromosomes/1/5000'][:,2].sum(), 7)
        self.assertEqual(z['chromosomes/2/5000'][:,0].sum(), 0)
        self.assertEqual(z['chromosomes/2/5000'][:,1].sum(), 0)
        self.assertEqual(z['chromosomes/2/10000'][:,0].sum(), 0)
        self.assertEqual(z['chromosomes/2/5000'][:,2].sum(), 4)
        self.assertEqual(z['chromosomes/2/5000'][:,3].sum(), 9)
        self.assertEqual(z['chromosomes/2/10000'][:,1].sum(), 13)
