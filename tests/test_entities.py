...
class TestEntities(unittest.TestCase):
    ...
    def test_cells_bad_polygon_outline_type(self):
        ...
        with self.assertRaises(Exception) as context:
            ...
            cells.add_polygon_outline([[[1, 1, 3], [1, 1], [1, 1]], [
                                      [2, 2], [2, 2], [2, 2]], [[3, 3], [3, 3], [3, 3]]])
        self.assertEqual(
            'Polygon outline for cell_1 should be a list of two element lists i.e xy coordinates', str(context.exception))
    ...
    def test_cells_bad_mappings_length(self):
        ...
        self.assertEqual(
            'Coordinates length does not match Cell IDs Length', str(context.exception))
    ...
    def test_cell_sets(self):
        ...
        cell_sets.add_node('Subcluster 1', ['Clusters', 'Cluster 1'], [
                           'cell_1', 'cell_2'])
        cell_sets.add_node('Subcluster 2', ['Clusters', 'Cluster 1'], [
                           'cell_3', 'cell_4'])
    ...
    def test_cell_sets_node_not_found(self):
        ...
        self.assertEqual(
            "No node with path ['Clusters Not Found'] found to add Cluster 1 to", str(context.exception))
