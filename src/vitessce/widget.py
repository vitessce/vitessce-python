...
class VitessceWidget(anywidget.AnyWidget):
    ...
    js_package_version = Unicode('3.9.11').tag(sync=True)
...
def ipython_display(config, height=600, theme='auto', base_url=None, host_name=None, uid=None, port=None, proxy=False, js_package_version='3.9.11', js_dev_mode=False, custom_js_url='', plugins=None, remount_on_uid_change=True, page_mode=False, page_esm=None, server_host=None):
